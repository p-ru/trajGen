  ...
  real_T varargin_2[8])
{
  ...
  exitg1 = false;
  while ((!exitg1) && (trajGen_with_yaw_B.b_k < 8)) {
    if ((varargin_1[trajGen_with_yaw_B.b_k] == varargin_2[trajGen_with_yaw_B.b_k])
        || (std::isnan(varargin_1[trajGen_with_yaw_B.b_k]) && std::isnan
            (varargin_2[trajGen_with_yaw_B.b_k]))) {
  ...
  *info)
{
  ...
  *info = 0;
  for (trajGen_with_yaw_B.b_j_a = 0; trajGen_with_yaw_B.b_j_a < 7;
    ...
    trajGen_with_yaw_B.c_ju = trajGen_with_yaw_B.b_j_a * 9 + 2;
    ...
    for (trajGen_with_yaw_B.k = 2; trajGen_with_yaw_B.k <=
      ...
      trajGen_with_yaw_B.s_d = std::abs(A[(trajGen_with_yaw_B.c_ju +
    ...
    if (A[(trajGen_with_yaw_B.c_ju + trajGen_with_yaw_B.a_o) - 3] != 0.0) {
      ...
      trajGen_with_yaw_B.k = trajGen_with_yaw_B.c_ju - trajGen_with_yaw_B.b_j_a;
      for (trajGen_with_yaw_B.c_jz = trajGen_with_yaw_B.c_ju;
    ...
    for (trajGen_with_yaw_B.a_o = 0; trajGen_with_yaw_B.a_o <
      ...
      if (trajGen_with_yaw_B.smax != 0.0) {
        ...
        for (trajGen_with_yaw_B.temp_tmp = trajGen_with_yaw_B.c_jz;
          ...
          A[trajGen_with_yaw_B.temp_tmp - 1] += A[((trajGen_with_yaw_B.c_ju +
...
static real_T trajGen_with_yaw_rcond(const real_T A[64])
{
  ...
  while ((!exitg1) && (trajGen_with_yaw_B.b_j < 8)) {
    ...
    for (trajGen_with_yaw_B.i_f = 0; trajGen_with_yaw_B.i_f < 8;
         trajGen_with_yaw_B.i_f++) {
  ...
  if (!(trajGen_with_yaw_B.normA == 0.0)) {
    ...
    do {
      ...
      if (trajGen_with_yaw_B.iter + 1 > 0) {
        ...
        for (trajGen_with_yaw_B.i_f = 0; trajGen_with_yaw_B.i_f < 8;
             trajGen_with_yaw_B.i_f++) {
          trajGen_with_yaw_B.x[trajGen_with_yaw_B.i_f] = 0.125;
        }
          ...
          if (trajGen_with_yaw_B.kase == 1) {
            for (trajGen_with_yaw_B.b_j = 0; trajGen_with_yaw_B.b_j < 8;
              ...
              trajGen_with_yaw_B.jA = (trajGen_with_yaw_B.b_j << 3) +
                trajGen_with_yaw_B.b_j;
              trajGen_with_yaw_B.c_j = 7 - trajGen_with_yaw_B.b_j;
              for (trajGen_with_yaw_B.i_f = 0; trajGen_with_yaw_B.i_f <
                   trajGen_with_yaw_B.c_j; trajGen_with_yaw_B.i_f++) {
                trajGen_with_yaw_B.ix = (trajGen_with_yaw_B.i_f +
                  trajGen_with_yaw_B.b_j) + 1;
                trajGen_with_yaw_B.x[trajGen_with_yaw_B.ix] -=
                  trajGen_with_yaw_B.c_A[(trajGen_with_yaw_B.i_f +
            ...
            for (trajGen_with_yaw_B.b_j = 7; trajGen_with_yaw_B.b_j >= 0;
              ...
              for (trajGen_with_yaw_B.i_f = 0; trajGen_with_yaw_B.i_f <
                   trajGen_with_yaw_B.b_j; trajGen_with_yaw_B.i_f++) {
                trajGen_with_yaw_B.ix = (trajGen_with_yaw_B.b_j -
                  trajGen_with_yaw_B.i_f) - 1;
                trajGen_with_yaw_B.x[trajGen_with_yaw_B.ix] -=
                  trajGen_with_yaw_B.c_A[(trajGen_with_yaw_B.jA -
                  trajGen_with_yaw_B.i_f) - 1] *
                  trajGen_with_yaw_B.x[trajGen_with_yaw_B.b_j];
            ...
            for (trajGen_with_yaw_B.b_j = 0; trajGen_with_yaw_B.b_j < 8;
              ...
              for (trajGen_with_yaw_B.i_f = 0; trajGen_with_yaw_B.i_f <
                ...
                trajGen_with_yaw_B.temp -=
                  trajGen_with_yaw_B.c_A[trajGen_with_yaw_B.jA +
                  trajGen_with_yaw_B.i_f] *
                  trajGen_with_yaw_B.x[trajGen_with_yaw_B.i_f];
              }
            ...
            for (trajGen_with_yaw_B.b_j = 7; trajGen_with_yaw_B.b_j >= 0;
              ...
              trajGen_with_yaw_B.temp =
                trajGen_with_yaw_B.x[trajGen_with_yaw_B.b_j];
              for (trajGen_with_yaw_B.i_f = 8; trajGen_with_yaw_B.i_f >=
                   trajGen_with_yaw_B.b_j + 2; trajGen_with_yaw_B.i_f--) {
                trajGen_with_yaw_B.temp -=
                  trajGen_with_yaw_B.c_A[trajGen_with_yaw_B.jA +
                  trajGen_with_yaw_B.i_f] *
                  trajGen_with_yaw_B.x[trajGen_with_yaw_B.i_f - 1];
              }
  ...
  *maxTimeStatus, real_T *singularityStatus)
{
  ...
  for (trajGen_with_yaw_B.b_p_tmp = 0; trajGen_with_yaw_B.b_p_tmp < 2;
    ...
    trajGen_with_yaw_B.d_o3[0] = d;
    trajGen_with_yaw_B.loop_ub = d;
    for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c < 4;
      ...
      for (trajGen_with_yaw_B.powerTerm = 0; trajGen_with_yaw_B.powerTerm <
           trajGen_with_yaw_B.loop_ub; trajGen_with_yaw_B.powerTerm++) {
        /* Start for MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory' */
        trajGen_with_yaw_B.constraints[(trajGen_with_yaw_B.e +
          trajGen_with_yaw_B.powerTerm) + (trajGen_with_yaw_B.c << 3)] =
          trajGen_with_yaw_B.upperleft[trajGen_with_yaw_B.d_o3[0] *
  ...
  for (trajGen_with_yaw_B.b_p_tmp = 0; trajGen_with_yaw_B.b_p_tmp < 4;
    ...
    for (trajGen_with_yaw_B.loop_ub = 0; trajGen_with_yaw_B.loop_ub < 7;
      ...
      trajGen_with_yaw_B.nz +=
        trajGen_with_yaw_B.x_tmp[trajGen_with_yaw_B.loop_ub + 1];
    }
    ...
    for (trajGen_with_yaw_B.loop_ub = 0; trajGen_with_yaw_B.loop_ub < 8;
         trajGen_with_yaw_B.loop_ub++) {
      trajGen_with_yaw_B.e = 8 - trajGen_with_yaw_B.loop_ub;
      for (trajGen_with_yaw_B.b_b = 0; trajGen_with_yaw_B.b_b <
           trajGen_with_yaw_B.e; trajGen_with_yaw_B.b_b++) {
        trajGen_with_yaw_B.row = trajGen_with_yaw_B.loop_ub +
          trajGen_with_yaw_B.b_b;
        for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c <
             trajGen_with_yaw_B.e; trajGen_with_yaw_B.c++) {
          trajGen_with_yaw_B.col = trajGen_with_yaw_B.loop_ub +
            trajGen_with_yaw_B.c;
          for (trajGen_with_yaw_B.powerTerm = 0; trajGen_with_yaw_B.powerTerm <
               trajGen_with_yaw_B.loop_ub; trajGen_with_yaw_B.powerTerm++) {
            /* Start for MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory' */
          ...
          trajGen_with_yaw_B.powerTerm = ((trajGen_with_yaw_B.row +
            trajGen_with_yaw_B.col) - (trajGen_with_yaw_B.loop_ub << 1)) + 1;
      ...
      /* Start for MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory' */
      trajGen_with_yaw_B.c = tmp[trajGen_with_yaw_B.loop_ub];
    ...
    for (trajGen_with_yaw_B.b_b = 0; trajGen_with_yaw_B.b_b < 4;
      ...
      for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c < 8;
        ...
        /* Start for MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory' */
        for (trajGen_with_yaw_B.loop_ub = 0; trajGen_with_yaw_B.loop_ub <
             trajGen_with_yaw_B.b_b; trajGen_with_yaw_B.loop_ub++) {
          trajGen_with_yaw_B.prod *= static_cast<real_T>(trajGen_with_yaw_B.c -
            trajGen_with_yaw_B.loop_ub);
        }
    ...
    for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c < 8;
         trajGen_with_yaw_B.c++) {
      trajGen_with_yaw_B.loop_ub = trajGen_with_yaw_B.c << 2;
      trajGen_with_yaw_B.powerTerm = trajGen_with_yaw_B.c << 3;
      trajGen_with_yaw_B.Q[trajGen_with_yaw_B.powerTerm] =
        trajGen_with_yaw_B.A0[trajGen_with_yaw_B.loop_ub];
      trajGen_with_yaw_B.Q[trajGen_with_yaw_B.powerTerm + 4] =
        trajGen_with_yaw_B.AT[trajGen_with_yaw_B.loop_ub];
      trajGen_with_yaw_B.Q[trajGen_with_yaw_B.powerTerm + 1] =
        trajGen_with_yaw_B.A0[trajGen_with_yaw_B.loop_ub + 1];
      trajGen_with_yaw_B.Q[trajGen_with_yaw_B.powerTerm + 5] =
        trajGen_with_yaw_B.AT[trajGen_with_yaw_B.loop_ub + 1];
      trajGen_with_yaw_B.Q[trajGen_with_yaw_B.powerTerm + 2] =
        trajGen_with_yaw_B.A0[trajGen_with_yaw_B.loop_ub + 2];
      trajGen_with_yaw_B.Q[trajGen_with_yaw_B.powerTerm + 6] =
        trajGen_with_yaw_B.AT[trajGen_with_yaw_B.loop_ub + 2];
      trajGen_with_yaw_B.Q[trajGen_with_yaw_B.powerTerm + 3] =
        trajGen_with_yaw_B.A0[trajGen_with_yaw_B.loop_ub + 3];
      trajGen_with_yaw_B.Q[trajGen_with_yaw_B.powerTerm + 7] =
        trajGen_with_yaw_B.AT[trajGen_with_yaw_B.loop_ub + 3];
    }
    ...
    for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c < 4;
         trajGen_with_yaw_B.c++) {
      /* Start for MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory' */
      trajGen_with_yaw_B.loop_ub = (trajGen_with_yaw_B.c + 4) << 3;
      trajGen_with_yaw_B.powerTerm = trajGen_with_yaw_B.c << 2;

      /* Start for MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory' */
      trajGen_with_yaw_B.Q_p[trajGen_with_yaw_B.powerTerm] =
        trajGen_with_yaw_B.Q[trajGen_with_yaw_B.loop_ub + 4];
      trajGen_with_yaw_B.Q_p[trajGen_with_yaw_B.powerTerm + 1] =
        trajGen_with_yaw_B.Q[trajGen_with_yaw_B.loop_ub + 5];
      trajGen_with_yaw_B.Q_p[trajGen_with_yaw_B.powerTerm + 2] =
        trajGen_with_yaw_B.Q[trajGen_with_yaw_B.loop_ub + 6];
      trajGen_with_yaw_B.Q_p[trajGen_with_yaw_B.powerTerm + 3] =
        trajGen_with_yaw_B.Q[trajGen_with_yaw_B.loop_ub + 7];
    }
    ...
    for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c < 4;
      ...
      for (trajGen_with_yaw_B.powerTerm = 0; trajGen_with_yaw_B.powerTerm < 4;
           trajGen_with_yaw_B.powerTerm++) {
        trajGen_with_yaw_B.loop_ub = trajGen_with_yaw_B.powerTerm << 3;
      ...
      for (trajGen_with_yaw_B.powerTerm = 0; trajGen_with_yaw_B.powerTerm < 4;
           trajGen_with_yaw_B.powerTerm++) {
        trajGen_with_yaw_B.loop_ub = trajGen_with_yaw_B.powerTerm << 2;
        trajGen_with_yaw_B.lowerright_f[trajGen_with_yaw_B.c +
          trajGen_with_yaw_B.loop_ub] =
          ((trajGen_with_yaw_B.upperleft[trajGen_with_yaw_B.loop_ub + 1] *
            trajGen_with_yaw_B.prod +
            trajGen_with_yaw_B.upperleft[trajGen_with_yaw_B.loop_ub] *
            trajGen_with_yaw_B.lowerright_d) +
           trajGen_with_yaw_B.upperleft[trajGen_with_yaw_B.loop_ub + 2] *
           trajGen_with_yaw_B.lowerright_g) +
          trajGen_with_yaw_B.upperleft[trajGen_with_yaw_B.loop_ub + 3] *
          trajGen_with_yaw_B.lowerright_l;
    ...
    for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c < 4;
      ...
      trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.powerTerm + 4] =
        trajGen_with_yaw_B.lowerright_f[trajGen_with_yaw_B.loop_ub];
      trajGen_with_yaw_B.e = (trajGen_with_yaw_B.c + 4) << 3;
      trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.e + 4] =
        trajGen_with_yaw_B.lowerright[trajGen_with_yaw_B.loop_ub];
      trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.powerTerm + 5] =
        trajGen_with_yaw_B.lowerright_f[trajGen_with_yaw_B.loop_ub + 1];
      trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.e + 5] =
        trajGen_with_yaw_B.lowerright[trajGen_with_yaw_B.loop_ub + 1];
      trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.powerTerm + 6] =
        trajGen_with_yaw_B.lowerright_f[trajGen_with_yaw_B.loop_ub + 2];
      trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.e + 6] =
        trajGen_with_yaw_B.lowerright[trajGen_with_yaw_B.loop_ub + 2];
      trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.powerTerm + 7] =
        trajGen_with_yaw_B.lowerright_f[trajGen_with_yaw_B.loop_ub + 3];
      trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.e + 7] =
        trajGen_with_yaw_B.lowerright[trajGen_with_yaw_B.loop_ub + 3];
    }
      ...
      for (trajGen_with_yaw_B.powerTerm = 0; trajGen_with_yaw_B.powerTerm < 8;
        ...
        for (trajGen_with_yaw_B.loop_ub = 0; trajGen_with_yaw_B.loop_ub < 8;
          ...
          trajGen_with_yaw_B.prod += trajGen_with_yaw_B.AInv_k
            [(trajGen_with_yaw_B.loop_ub << 3) + trajGen_with_yaw_B.c] *
    ...
    trajGen_with_yaw_B.loop_ub -= trajGen_with_yaw_B.col;
    trajGen_with_yaw_B.R_size[1] = trajGen_with_yaw_B.loop_ub + 1;
    for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c <=
         trajGen_with_yaw_B.loop_ub; trajGen_with_yaw_B.c++) {
      for (trajGen_with_yaw_B.powerTerm = 0; trajGen_with_yaw_B.powerTerm <
    ...
    /* Start for MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory' */
    trajGen_with_yaw_B.R_size_l[0] = trajGen_with_yaw_B.loop_ub + 1;
    trajGen_with_yaw_B.R_size_l[1] = trajGen_with_yaw_B.loop_ub + 1;
    for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c <=
         trajGen_with_yaw_B.loop_ub; trajGen_with_yaw_B.c++) {
      for (trajGen_with_yaw_B.powerTerm = 0; trajGen_with_yaw_B.powerTerm <=
           trajGen_with_yaw_B.loop_ub; trajGen_with_yaw_B.powerTerm++) {
        /* Start for MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory' */
        trajGen_with_yaw_B.AInv[trajGen_with_yaw_B.powerTerm +
          (trajGen_with_yaw_B.loop_ub + 1) * trajGen_with_yaw_B.c] =
          -trajGen_with_yaw_B.Qsum[(((trajGen_with_yaw_B.row +
    ...
    trajGen_with_yaw_B.loop_ub = trajGen_with_yaw_B.r1.size(0);
    for (trajGen_with_yaw_B.c = 0; trajGen_with_yaw_B.c <
         trajGen_with_yaw_B.loop_ub; trajGen_with_yaw_B.c++) {
      trajGen_with_yaw_B.upperleft[trajGen_with_yaw_B.c +
        trajGen_with_yaw_B.tmp_size_idx_0] =
...
void trajGen_with_yaw_step(void)
{
  ...
  if (trajGen_with_yaw_B.In1_c.Data) {
    ...
    trajGen_with_yaw_B.pair[0] = trajGen_with_yaw_DW.startPosition[0];
    trajGen_with_yaw_B.pair[1] = trajGen_with_yaw_B.In1_h.Position.X;
    trajGen_with_yaw_B.pair[2] = trajGen_with_yaw_DW.startPosition[1];
    trajGen_with_yaw_B.pair[3] = trajGen_with_yaw_B.In1_h.Position.Y;
    trajGen_with_yaw_B.pair[4] = trajGen_with_yaw_DW.startPosition[2];
    trajGen_with_yaw_B.pair[5] = trajGen_with_yaw_B.In1_h.Position.Z;
    trajGen_with_yaw_B.pair[6] = trajGen_with_yaw_DW.startPosition[3];
    trajGen_with_yaw_B.pair[7] =
     ...
     *  SignalConversion generated from: '<S5>/Coordinate Transformation Conversion'
     */
    std::memcpy(&trajGen_with_yaw_B.unrapped_points[0],
                &trajGen_with_yaw_B.pair[0], sizeof(real_T) << 3U);
    trajGen_with_yaw_B.unwrapped_angles[0] = trajGen_with_yaw_DW.startPosition[3];
    trajGen_with_yaw_B.q =
      trajGen_with_yaw_B.CoordinateTransformationConve_p.CoordinateTransformationConve_p
      [0] - trajGen_with_yaw_DW.startPosition[3];
    if (std::isnan(trajGen_with_yaw_B.q + 3.1415926535897931) || std::isinf
        (trajGen_with_yaw_B.q + 3.1415926535897931)) {
      trajGen_with_yaw_B.error_x_body = (rtNaN);
    } else if (trajGen_with_yaw_B.q + 3.1415926535897931 == 0.0) {
      trajGen_with_yaw_B.error_x_body = 0.0;
    } else {
      trajGen_with_yaw_B.error_x_body = std::fmod(trajGen_with_yaw_B.q +
        3.1415926535897931, 6.2831853071795862);
      rEQ0 = (trajGen_with_yaw_B.error_x_body == 0.0);
      if (!rEQ0) {
        trajGen_with_yaw_B.q = std::abs((trajGen_with_yaw_B.q +
          3.1415926535897931) / 6.2831853071795862);
        rEQ0 = !(std::abs(trajGen_with_yaw_B.q - std::floor(trajGen_with_yaw_B.q
                   + 0.5)) > 2.2204460492503131E-16 * trajGen_with_yaw_B.q);
      }

      if (rEQ0) {
        trajGen_with_yaw_B.error_x_body = 0.0;
      } else if (trajGen_with_yaw_B.error_x_body < 0.0) {
        trajGen_with_yaw_B.error_x_body += 6.2831853071795862;
      }
    }

    trajGen_with_yaw_B.unwrapped_angles[1] = (trajGen_with_yaw_B.error_x_body -
      3.1415926535897931) + trajGen_with_yaw_DW.startPosition[3];
    for (trajGen_with_yaw_B.i = 0; trajGen_with_yaw_B.i < 2;
         trajGen_with_yaw_B.i++) {
      trajGen_with_yaw_B.error_x_body =
        trajGen_with_yaw_B.unwrapped_angles[trajGen_with_yaw_B.i];
      trajGen_with_yaw_B.unrapped_points[trajGen_with_yaw_B.i + 6] =
        trajGen_with_yaw_B.error_x_body;

      /* Math: '<S5>/Transpose' */
      trajGen_with_yaw_B.rtb_Transpose_tmp = trajGen_with_yaw_B.i << 2;
      trajGen_with_yaw_B.Transpose[trajGen_with_yaw_B.rtb_Transpose_tmp] =
        trajGen_with_yaw_B.unrapped_points[trajGen_with_yaw_B.i];
      trajGen_with_yaw_B.Transpose[trajGen_with_yaw_B.rtb_Transpose_tmp + 1] =
        trajGen_with_yaw_B.unrapped_points[trajGen_with_yaw_B.i + 2];
      trajGen_with_yaw_B.Transpose[trajGen_with_yaw_B.rtb_Transpose_tmp + 2] =
        trajGen_with_yaw_B.unrapped_points[trajGen_with_yaw_B.i + 4];
      trajGen_with_yaw_B.Transpose[trajGen_with_yaw_B.rtb_Transpose_tmp + 3] =
        trajGen_with_yaw_B.error_x_body;
    }
    ...
    for (trajGen_with_yaw_B.i = 0; trajGen_with_yaw_B.i < 2;
         trajGen_with_yaw_B.i++) {
      trajGen_with_yaw_B.rtb_Transpose_tmp = trajGen_with_yaw_B.i << 2;
      trajGen_with_yaw_B.unrapped_points[trajGen_with_yaw_B.rtb_Transpose_tmp] =
        trajGen_with_yaw_B.pair[trajGen_with_yaw_B.i];
      trajGen_with_yaw_B.unrapped_points[trajGen_with_yaw_B.rtb_Transpose_tmp +
        1] = trajGen_with_yaw_B.pair[trajGen_with_yaw_B.i + 2];
      trajGen_with_yaw_B.unrapped_points[trajGen_with_yaw_B.rtb_Transpose_tmp +
        2] = trajGen_with_yaw_B.pair[trajGen_with_yaw_B.i + 4];
      trajGen_with_yaw_B.unrapped_points[trajGen_with_yaw_B.rtb_Transpose_tmp +
        3] = trajGen_with_yaw_B.pair[trajGen_with_yaw_B.i + 6];
    }

    trajGen_with_yaw_B.VectorConcatenate3[0] =
      trajGen_with_yaw_B.unrapped_points[4] -
      trajGen_with_yaw_B.unrapped_points[0];
    trajGen_with_yaw_B.VectorConcatenate3[1] =
      trajGen_with_yaw_B.unrapped_points[5] -
      trajGen_with_yaw_B.unrapped_points[1];
    trajGen_with_yaw_B.VectorConcatenate3[2] =
      trajGen_with_yaw_B.unrapped_points[6] -
      trajGen_with_yaw_B.unrapped_points[2];
    trajGen_with_yaw_B.VectorConcatenate3[3] =
      trajGen_with_yaw_B.unrapped_points[7] -
      trajGen_with_yaw_B.unrapped_points[3];
    trajGen_with_yaw_B.unwrapped_angles[0] = 0.0 / trajGen_with_yaw_B.delT;
    trajGen_with_yaw_B.unwrapped_angles[1] = std::sqrt
      (((trajGen_with_yaw_B.VectorConcatenate3[0] *
         trajGen_with_yaw_B.VectorConcatenate3[0] +
         trajGen_with_yaw_B.VectorConcatenate3[1] *
         trajGen_with_yaw_B.VectorConcatenate3[1]) +
    ...
    trajGen_with_yaw_B.unwrapped_angles[1] +=
      trajGen_with_yaw_B.unwrapped_angles[0];
    ...
    if (trajGen_with_yaw_DW.obj.StartFlag) {
      ...
      rEQ0 = false;
      if (!trajGen_with_yaw_isequaln(trajGen_with_yaw_B.Transpose,
           trajGen_with_yaw_DW.obj.PrevWaypoint)) {
        rEQ0 = true;
      } else {
        p = false;
        p_0 = true;
        trajGen_with_yaw_B.i = 0;
        exitg1 = false;
        while ((!exitg1) && (trajGen_with_yaw_B.i < 2)) {
          if ((trajGen_with_yaw_B.unwrapped_angles[trajGen_with_yaw_B.i] ==
               trajGen_with_yaw_DW.obj.PrevTimePoint[trajGen_with_yaw_B.i]) ||
              (std::isnan
               (trajGen_with_yaw_B.unwrapped_angles[trajGen_with_yaw_B.i]) &&
               std::isnan
               (trajGen_with_yaw_DW.obj.PrevTimePoint[trajGen_with_yaw_B.i]))) {
        ...
        if (!p) {
          ...
          std::memset(&trajGen_with_yaw_B.pair[0], 0, sizeof(real_T) << 3U);
          if (!trajGen_with_yaw_isequaln(trajGen_with_yaw_B.pair,
    ...
    if (guard1) {
      MinJerkPolyTraj_computePPandTim(&trajGen_with_yaw_DW.obj,
        trajGen_with_yaw_B.Transpose, trajGen_with_yaw_B.unwrapped_angles,
        trajGen_with_yaw_B.ppMatrix, trajGen_with_yaw_B.r,
        &trajGen_with_yaw_B.delT, &trajGen_with_yaw_B.error_x_body,
        &trajGen_with_yaw_B.q);
      trajGen_with_yaw_DW.obj.SingularityStatus = trajGen_with_yaw_B.q;
      ...
      trajGen_with_yaw_B.rtb_Transpose_tmp = trajGen_with_yaw_B.r.size(0) *
        trajGen_with_yaw_B.r.size(1) - 1;
      for (trajGen_with_yaw_B.i = 0; trajGen_with_yaw_B.i <=
           trajGen_with_yaw_B.rtb_Transpose_tmp; trajGen_with_yaw_B.i++) {
        trajGen_with_yaw_DW.obj.TimeOfArrZero[trajGen_with_yaw_B.i] =
          trajGen_with_yaw_B.r[trajGen_with_yaw_B.i];
      }

      trajGen_with_yaw_DW.obj.PPMatrix.set_size(1, 8, 4);
      for (trajGen_with_yaw_B.i = 0; trajGen_with_yaw_B.i < 32;
           trajGen_with_yaw_B.i++) {
        trajGen_with_yaw_DW.obj.PPMatrix[trajGen_with_yaw_B.i] =
          trajGen_with_yaw_B.ppMatrix[trajGen_with_yaw_B.i];
      }
    ...
    if (trajGen_with_yaw_DW.obj.TimeOfArrZero.size(1) == 2) {
      trajGen_with_yaw_B.rtb_Transpose_tmp =
        trajGen_with_yaw_DW.obj.TimeOfArrZero.size(1);
      for (trajGen_with_yaw_B.i = 0; trajGen_with_yaw_B.i <
           trajGen_with_yaw_B.rtb_Transpose_tmp; trajGen_with_yaw_B.i++) {
        trajGen_with_yaw_B.dv1[trajGen_with_yaw_B.i] =
          trajGen_with_yaw_DW.obj.TimeOfArrZero[trajGen_with_yaw_B.i] +
          trajGen_with_yaw_DW.obj.TimeOffset;
      }
    } else {
      trajGen_with_y_binary_expand_op(trajGen_with_yaw_B.dv1,
        &trajGen_with_yaw_DW.obj);
    }

    if (trajGen_with_yaw_DW.DiscreteTimeIntegrator_DSTATE <
        trajGen_with_yaw_B.dv1[0]) {
      trajGen_with_yaw_B.VectorConcatenate3[0] = trajGen_with_yaw_B.Transpose[0];
      trajGen_with_yaw_B.VectorConcatenate3[1] = trajGen_with_yaw_B.Transpose[1];
      trajGen_with_yaw_B.VectorConcatenate3[2] = trajGen_with_yaw_B.Transpose[2];
      trajGen_with_yaw_B.VectorConcatenate3[3] = trajGen_with_yaw_B.Transpose[3];
    } else if (trajGen_with_yaw_DW.DiscreteTimeIntegrator_DSTATE >
               trajGen_with_yaw_B.dv1[1]) {
      trajGen_with_yaw_B.VectorConcatenate3[0] = trajGen_with_yaw_B.Transpose[4];
      trajGen_with_yaw_B.VectorConcatenate3[1] = trajGen_with_yaw_B.Transpose[5];
      trajGen_with_yaw_B.VectorConcatenate3[2] = trajGen_with_yaw_B.Transpose[6];
      trajGen_with_yaw_B.VectorConcatenate3[3] = trajGen_with_yaw_B.Transpose[7];
    } else {
      trajGen_with_yaw_B.delT =
        trajGen_with_yaw_DW.DiscreteTimeIntegrator_DSTATE -
        trajGen_with_yaw_B.dv1[0];
      for (trajGen_with_yaw_B.i = 0; trajGen_with_yaw_B.i < 4;
           trajGen_with_yaw_B.i++) {
        if (std::isnan(trajGen_with_yaw_B.delT)) {
          ...
          trajGen_with_yaw_B.error_x_body = trajGen_with_yaw_DW.obj.PPMatrix
            ...
            trajGen_with_yaw_B.i];
          for (trajGen_with_yaw_B.rtb_Transpose_tmp = 0;
               trajGen_with_yaw_B.rtb_Transpose_tmp < 7;
               trajGen_with_yaw_B.rtb_Transpose_tmp++) {
            trajGen_with_yaw_B.error_x_body = trajGen_with_yaw_DW.obj.PPMatrix
              [(trajGen_with_yaw_B.rtb_Transpose_tmp + 1) *
              trajGen_with_yaw_DW.obj.PPMatrix.size(0) +
              (trajGen_with_yaw_DW.obj.PPMatrix.size(0) << 3) *
              trajGen_with_yaw_B.i] + trajGen_with_yaw_B.delT *
              trajGen_with_yaw_B.error_x_body;
          }
        }

        trajGen_with_yaw_B.VectorConcatenate3[trajGen_with_yaw_B.i] =
          trajGen_with_yaw_B.error_x_body;
      }
    }

    trajGen_with_yaw_DW.obj.PrevTimePoint[0] =
      trajGen_with_yaw_B.unwrapped_angles[0];
    trajGen_with_yaw_DW.obj.PrevTimePoint[1] =
      trajGen_with_yaw_B.unwrapped_angles[1];
    for (trajGen_with_yaw_B.i = 0; trajGen_with_yaw_B.i < 8;
         trajGen_with_yaw_B.i++) {
      trajGen_with_yaw_DW.obj.PrevWaypoint[trajGen_with_yaw_B.i] =
        trajGen_with_yaw_B.Transpose[trajGen_with_yaw_B.i];
      trajGen_with_yaw_DW.obj.PrevVelBC[trajGen_with_yaw_B.i] = 0.0;
      trajGen_with_yaw_DW.obj.PrevAccelBC[trajGen_with_yaw_B.i] = 0.0;
      trajGen_with_yaw_DW.obj.PrevJerkBC[trajGen_with_yaw_B.i] = 0.0;
    }
     ...
     *  MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory'
     */
    trajGen_with_yaw_B.diff = trajGen_with_yaw_B.VectorConcatenate3[1] -
      trajGen_with_yaw_B.In1.Pose.Pose.Position.Y;
     ...
     *  SignalConversion generated from: '<S5>/Coordinate Transformation Conversion1'
     */
    trajGen_with_yaw_B.Filter_e = std::sin
      (-trajGen_with_yaw_B.CoordinateTransformationConv_pn.CoordinateTransformationConve_p
       [0]);
    trajGen_with_yaw_B.q = std::cos
      (-trajGen_with_yaw_B.CoordinateTransformationConv_pn.CoordinateTransformationConve_p
       [0]);
    trajGen_with_yaw_B.error_x_body = trajGen_with_yaw_B.q *
      trajGen_with_yaw_B.delT - trajGen_with_yaw_B.Filter_e *
      trajGen_with_yaw_B.diff;
    trajGen_with_yaw_B.diff = trajGen_with_yaw_B.Filter_e *
      trajGen_with_yaw_B.delT + trajGen_with_yaw_B.q * trajGen_with_yaw_B.diff;
     ...
     *  Sum: '<S102>/SumD'
     */
    trajGen_with_yaw_B.delT = (0.08 * trajGen_with_yaw_B.diff -
     ...
     *  Sum: '<S116>/Sum'
     */
    trajGen_with_yaw_B.Gain3 = -(0.7 * trajGen_with_yaw_B.diff +
      trajGen_with_yaw_B.delT);
     ...
     *  Sum: '<S50>/SumD'
     */
    trajGen_with_yaw_B.q = (0.08 * trajGen_with_yaw_B.error_x_body -
    ...
    /* Product: '<S69>/Ungain*Ts Prod Out' */
    trajGen_with_yaw_B.diff = trajGen_with_yaw_B.q * 0.0;

    /* Sum: '<S5>/Sum2' incorporates:
     *  MATLABSystem: '<S5>/Minimum Jerk Polynomial Trajectory'
     */
    trajGen_with_yaw_B.q = trajGen_with_yaw_B.VectorConcatenate3[2] -
      trajGen_with_yaw_B.In1.Pose.Pose.Position.Z;
     ...
     *  Sum: '<S206>/SumD'
     */
    trajGen_with_yaw_B.Filter_e = (0.08 * trajGen_with_yaw_B.q -
     ...
     *  Sum: '<S220>/Sum'
     */
    trajGen_with_yaw_B.Gain1 = -(0.9 * trajGen_with_yaw_B.q +
      trajGen_with_yaw_B.Filter_e);
     ...
     *  SignalConversion generated from: '<S5>/Coordinate Transformation Conversion1'
     */
    trajGen_with_yaw_B.q = trajGen_with_yaw_B.VectorConcatenate3[3] -
      trajGen_with_yaw_B.CoordinateTransformationConv_pn.CoordinateTransformationConve_p
      [0];
     ...
     *  Sum: '<S154>/SumD'
     */
    trajGen_with_yaw_B.q = ((trajGen_with_yaw_B.error_x_body -
      3.1415926535897931) * 0.08 - trajGen_with_yaw_DW.Filter_DSTATE_d) * 3.0;
     ...
     *  Sum: '<S168>/Sum'
     */
    trajGen_with_yaw_B.Gain2 = -(((trajGen_with_yaw_B.error_x_body -
      3.1415926535897931) * 0.7 + trajGen_with_yaw_B.q) * 57.295779513082323);
     ...
     *  Product: '<S121>/Ungain*Ts Prod Out'
     */
    trajGen_with_yaw_DW.Filter_DSTATE += trajGen_with_yaw_B.delT * 0.0;

    /* Update for DiscreteIntegrator: '<S50>/Filter' */
    trajGen_with_yaw_DW.Filter_DSTATE_j += trajGen_with_yaw_B.diff;

    /* Update for DiscreteIntegrator: '<S206>/Filter' incorporates:
     *  Product: '<S225>/Ungain*Ts Prod Out'
     */
    trajGen_with_yaw_DW.Filter_DSTATE_b += trajGen_with_yaw_B.Filter_e * 0.0;

    /* Update for DiscreteIntegrator: '<S154>/Filter' incorporates:
     *  Product: '<S173>/Ungain*Ts Prod Out'
     */
    trajGen_with_yaw_DW.Filter_DSTATE_d += trajGen_with_yaw_B.q * 0.0;
  } else if (trajGen_with_yaw_DW.Subsystem_MODE) {
    /* Disable for Sum: '<S64>/Sum' incorporates:
     *  Outport: '<S5>/x'
     */
...
void trajGen_with_yaw_initialize(void)
{
  ...
  /* SystemInitialize for Sum: '<S64>/Sum' incorporates:
   *  Outport: '<S5>/x'
   */
  trajGen_with_yaw_B.Sum = 0.0;
  ...
  /* SystemInitialize for SignalConversion generated from: '<S229>/In1' */
