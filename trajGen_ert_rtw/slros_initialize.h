...
extern SimulinkPublisher<std_msgs::Bool, SL_Bus_trajGen_std_msgs_Bool> Pub_trajGen_378;
...
extern SimulinkParameterGetter<real64_T, double> ParamGet_trajGen_318;
